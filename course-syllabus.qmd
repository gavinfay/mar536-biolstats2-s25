...
-   R open office: Thu 1-3, SMAST-E 235

-   By appointment: Mon 1-3, Tue 4-5
...
iii. Data exploration report containing data summaries and visualizations of the dataset to be used in the project, including observations of implications of data structure for the analyses to be conducted (Due Feb 27), and brief in-class update (on Mar 4). (10% of course grade).

iv. In-class verbal update (3 minute presentation) on project progress on Apr 1. (5% of course grade).
